...
public class DoctorScreenForPatientRegisterbydoc extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_logout){
            ...
            Intent intent = new Intent(DoctorScreenForPatientRegisterbydoc.this, WHOGuidelines.class);
            intent.putExtra("EXTRA_PATIENT_ID", clickedPatientId);
            startActivity(intent);
        } else if (item.getItemId() == R.id.action_refresh){
            getPatientData(clickedPatientId);
        } else if (item.getItemId() == R.id.patientDetails){
            Intent intent = new Intent(DoctorScreenForPatientRegisterbydoc.this, patientDetailInDoctor.class);
            intent.putExtra("EXTRA_PATIENT_ID", clickedPatientId);
            startActivity(intent);
        }
    ...
    private void logout(Context _c) {
        ...
        session.logoutUser();
        Intent i = new Intent(DoctorScreenForPatientRegisterbydoc.this, ControllerActivity.class);
        startActivity(i);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_screen_for_patient_registerbydoc);
...
//        });
        ...
        NotificationByDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoctorScreenForPatientRegisterbydoc.this, patientDataEntry.class);
                startActivity(intent);
            }
        });
        ...
        MedicineReminderDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoctorScreenForPatientRegisterbydoc.this, MedicineReminder.class);
                intent.putExtra("EXTRA_PATIENT_ID", clickedPatientId);
                startActivity(intent);
            }
        });
...
//                            }
                            String date = response.getString("edd").split("T")[0].split("-")[2] + "-" + response.getString("edd").split("T")[0].split("-")[1] + "-" + response.getString("lmp").split("T")[0].split("-")[0];
                            ...
                            if(patientBpData.length()==0){
                                ...
                                patientBpData = ja;
                                Toast.makeText(DoctorScreenForPatientRegisterbydoc.this, "Dummy Data", Toast.LENGTH_LONG).show();
...
//                                    }
                                    ...
                                    if(po.getInt("systolic") >160){
                                        colorssys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chart6)) ;
                                    } else if (po.getInt("systolic") > 140 && po.getInt("systolic") <= 160){
                                        colorssys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chart4)) ;
                                    } else if (po.getInt("systolic") <= 145){
                                        colorssys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chartsys)) ;
                                    }

                                    if(po.getInt("diastolic") > 110){
                                        colorsdys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chart6)) ;
                                    } else if (po.getInt("diastolic") > 90 && po.getInt("diastolic") <= 110 ){
                                        colorsdys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chart4)) ;
                                    } else if (po.getInt("diastolic") <= 90 || len == 1){
                                        colorsdys.add(ContextCompat.getColor(DoctorScreenForPatientRegisterbydoc.this, R.color.chartdys)) ;
                                    }
...
//                                set2.setDrawCircles(false);
                                ...
                                patientDataAdapter itemsAdapter = new patientDataAdapter(DoctorScreenForPatientRegisterbydoc.this, patientRowData);
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.sendNotif) {
                    if (message_box.getText().length() == 0) {
                        Toast.makeText(DoctorScreenForPatientRegisterbydoc.this, "enter your message", Toast.LENGTH_LONG).show();
                        return;
                    }
